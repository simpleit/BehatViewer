...
/**
 * BehatViewer\BehatViewerCoreBundle\Entity\Definition
 *
 * @ORM\Table(name="definition")
 * @ORM\Entity(repositoryClass="BehatViewer\BehatViewerCoreBundle\Entity\Repository\DefinitionRepository")
 */
