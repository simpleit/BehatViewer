...
/**
 * BehatViewer\BehatViewerCoreBundle\Entity\Scenario
 *
 * @ORM\Table(name="scenario")
 * @ORM\Entity(repositoryClass="BehatViewer\BehatViewerCoreBundle\Entity\Repository\ScenarioRepository")
 */
class Scenario extends Base
{
    ...
    /**
     * @var \BehatViewer\BehatViewerCoreBundle\Entity\Feature $feature
     *
     ...
     */
    public function setFeature(Entity\Feature $feature)
    {
     ...
     */
    public function addStep(Entity\Step $step)
    {
        $this->steps[] = $step;
    }
