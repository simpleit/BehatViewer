 ...
 *         }
 * )
 * @ORM\Entity(repositoryClass="BehatViewer\BehatViewerCoreBundle\Entity\Repository\ProjectRepository")
...
class Project extends Base
{
    ...
    /**
     * @var \BehatViewer\BehatViewerCoreBundle\Entity\Configuration $configuration
     *
    ...
    /**
     * @var \BehatViewer\BehatViewerCoreBundle\Entity\Strategy $strategy
     *
    ...
    /**
     * @var \BehatViewer\BehatViewerCoreBundle\Entity\User $user
     *
    ...
    public function setStrategy(Entity\Strategy $strategy)
    {
     ...
     */
    public function addBuild(Entity\Build $builds)
    {
        $this->builds[] = $builds;
    }
     ...
     * Add definitions
     *
     * @param \BehatViewer\BehatViewerCoreBundle\Entity\Definition $definitions
     */
    public function addDefinition(Entity\Definition $definitions)
    {
