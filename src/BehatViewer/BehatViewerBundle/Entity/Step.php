...
/**
 * BehatViewer\BehatViewerBundle\Entity\Step
 *
 * @ORM\Table(name="step")
 * @ORM\Entity(repositoryClass="BehatViewer\BehatViewerBundle\Entity\Repository\StepRepository")
 */
class Step extends Base
{
    ...
    /**
     * @var \BehatViewer\BehatViewerBundle\Entity\Scenario $scenario
     *
     ...
     * Set scenario
     *
     * @param \BehatViewer\BehatViewerBundle\Entity\Scenario $scenario
     */
    public function setScenario(\BehatViewer\BehatViewerBundle\Entity\Scenario $scenario)
    {
