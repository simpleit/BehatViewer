...
/**
 * BehatViewer\BehatViewerBundle\Entity\Feature
 *
 * @ORM\Table(name="feature")
 * @ORM\Entity(repositoryClass="BehatViewer\BehatViewerBundle\Entity\Repository\FeatureRepository")
 */
class Feature extends Base
{
    ...
    /**
     * @var \BehatViewer\BehatViewerBundle\Entity\Build $build
     *
    ...
    /**
     * @var \BehatViewer\BehatViewerBundle\Entity\FeatureStat $stat
     *
     ...
     */
    public function addTag(\BehatViewer\BehatViewerBundle\Entity\Tag $tag)
    {
        $this->tags[] = $tag;
    }
     ...
     */
    public function setBuild(\BehatViewer\BehatViewerBundle\Entity\Build $build)
    {
        $this->build = $build;
    }
